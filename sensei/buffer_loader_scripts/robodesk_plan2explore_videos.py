...
if __name__ == "__main__":
    ...
    job_id = 1
    run_name = "test_robodesk10_interactions_reward_heads_longer" #"test_motifrobodesk_final_grid_more"
    ...
    for start_i  in range(len(images)-num_rollouts*ep_length, len(images), ep_length):
        ...
        output_path = f"dreamer_robodesk_promotional_videos/Plan2Explore/{run_name}_{job_id}"
